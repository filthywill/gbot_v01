      ...
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="mb-6 p-4 bg-gray-100 rounded">
            ...
            <>
              <div className="mb-2">
                ...
                {sessionInfo.hasSession ? (
                  ...
                  <span className="text-red-600 ml-2">No active session</span>
                )}
              </div>
          ...
          {sessionInfo?.hasSession && (
            <button 
              onClick={signOut}
              className="mt-2 ml-2 px-3 py-1 bg-red-100 text-red-800 rounded text-sm"
            >
              Sign Out
            </button>
          )}
        ...
        <div className="flex space-x-2 mb-6">
          <button 
            ...
            className="px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700 flex-1 disabled:opacity-50"
          >
          ...
          <button 
            ...
            className="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 flex-1 disabled:opacity-50"
          >
        ...
        {testResults && (
          <div className="mt-4 p-4 bg-gray-100 rounded">
              ...
              <>
                <div className="mb-2">
                  ...
                  {testResults.verified === true ? (
                    ...
                    <span className="text-red-600 ml-2">Not Verified</span>
                  ) : (
                    <span className="text-amber-600 ml-2">Unknown</span>
                  )}
                </div>
            ...
            <pre className="mt-2 text-xs bg-gray-200 p-2 rounded overflow-auto max-h-64">
        ...
        <div className="mt-4 text-center">
          <a href="/" className="text-sm text-indigo-600 hover:underline">Return to Home</a>
        </div>
      </div>
    </div>
  );
