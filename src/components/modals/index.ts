 ...
 * Modal Components
 * 
 * This module exports modal components that are used throughout the application.
 * These components are extracted from App.tsx as part of the refactoring process.
 */
