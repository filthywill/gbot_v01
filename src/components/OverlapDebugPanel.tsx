...
${formattedSpecialCases}
  ...
  return (
    <div className="fixed bottom-4 right-4 bg-white p-3 rounded-lg shadow-lg border border-gray-200 w-72 text-sm">
      <div className="flex items-center justify-between mb-3">
        <h3 className="font-medium">Overlap Debug</h3>
        {selectedLetter && (
      ...
      <div>
        ...
        <select
          ...
          className="w-full rounded-md border border-gray-300 shadow-sm px-2 py-1 text-sm"
        >
          <option value="">Select...</option>
          {Array.from('abcdefghijklmnopqrstuvwxyz0123456789').map((letter) => (
            <option key={letter} value={letter} className="flex items-center justify-between">
        ...
        <>
          <div>
            ...
            <div className="flex space-x-2">
              ...
              <input
                ...
                value={minOverlap}
                onChange={(e) => handleMinOverlapChange(e.target.value)}
                className="w-16 rounded-md border border-gray-300 shadow-sm px-1 py-0.5 text-xs"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-md border border-gray-300 shadow-sm px-2 py-1 text-sm mb-2"
            >
